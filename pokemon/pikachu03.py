...
def main():
    ...
    # Create a list to store items with the word search on
    matchedwords = []
    ...
    with open ('pokemonitems.txt', 'w') as f:
        f.write(str(matchedwords))
    with open ('pokemonitems.json', 'w') as f:
        json.dump(matchedwords, f)
